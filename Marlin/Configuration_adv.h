...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_STEPPER_XY { {  347, 43.5 }, { 347, 297 }, { -36, 171 } }
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_XY .002       // (steps or mm) Steps or millimeter distance for each XY babystep
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH   125  // (mm) Slow length, to allow time to insert material.
